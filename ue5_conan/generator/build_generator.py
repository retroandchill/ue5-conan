...
class UnrealPluginDeps:
    ...
    def set_up_shell_project(self):
        ...
        content.engine_association = self.conanfile.options.ue_version
        content.plugins.append(AddedPlugin(name=self.plugin_name, enabled=True))
